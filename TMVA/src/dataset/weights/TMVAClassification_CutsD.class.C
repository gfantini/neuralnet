...
class ReadCutsD : public IClassifierReader {
 ...
 public:
   ...
   {      
      ...
      fVmin[0] = -1.7942920923233;
      fVmax[0] = 6.81769895553589;
      fVmin[1] = 5.82055139541626;
      fVmax[1] = 13.8268527984619;
...
inline void ReadCutsD::InitTransform_1()
{
   ...
   fDecTF_1[0][0][0] = 1.00068345739;
   fDecTF_1[0][0][1] = 0.000891868634452;
   fDecTF_1[0][1][0] = 0.000891868634452;
   fDecTF_1[0][1][1] = 0.996167808276;
   fDecTF_1[1][0][0] = 0.997382642698;
   fDecTF_1[1][0][1] = -0.00411582910053;
   fDecTF_1[1][1][0] = -0.00411582910053;
   fDecTF_1[1][1][1] = 1.25264047365;
   fDecTF_1[2][0][0] = 0.911553260512;
   fDecTF_1[2][0][1] = 0.10105177033;
   fDecTF_1[2][1][0] = 0.10105177033;
   fDecTF_1[2][1][1] = 0.982778584582;
}
