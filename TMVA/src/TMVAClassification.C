...
int TMVAClassification( TString myMethodList = "" )
{
   ...
   Use["FDA_GA"]          = 0; // minimisation of user-defined function using Genetics Algorithm // GF DISABLED
   Use["FDA_SA"]          = 0;
   Use["FDA_MC"]          = 0;
   Use["FDA_MT"]          = 0;
   Use["FDA_GAMT"]        = 0;
   ...
   TString fname = "../input/myTMVA.root";
   ...
   dataloader->AddVariable( "myvar1 := x1", 'F' );
   dataloader->AddVariable( "myvar2 := x2", 'F' );
   //   dataloader->AddVariable( "myvar2 := x2", "Expression 2", "", 'F' );
